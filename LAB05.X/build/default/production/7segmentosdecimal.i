# 1 "7segmentosdecimal.s"
# 1 "<built-in>" 1
# 1 "7segmentosdecimal.s" 2
...
isr:
    btfsc ((INTCON) and 07Fh), 0 ;Para revisar la interrupcion por cambio
    call boton
...
config_inter_eneable:
    ...
    bsf ((INTCON) and 07Fh), 7 ;encender interrupciones
    bsf ((INTCON) and 07Fh), 3 ;interrupcion por cambio en el pueto b
    bcf ((INTCON) and 07Fh), 0 ;borrar la bandera de la interrupcion en b
    bsf ((INTCON) and 07Fh), 5 ;encender interrupcion timer0
    return
